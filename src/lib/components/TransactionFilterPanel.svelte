<script lang="ts">
	import DateFilterMenu from '$lib/components/DateFilterMenu.svelte';
	import CategoryFilterMenu from '$lib/components/CategoryFilterMenu.svelte';
	import TypeFilterMenu from '$lib/components/TypeFilterMenu.svelte';
